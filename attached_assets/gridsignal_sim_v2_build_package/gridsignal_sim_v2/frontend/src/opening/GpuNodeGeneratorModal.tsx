...
export function GpuNodeGeneratorModal({ onClose, initialTab }: Props) {
  ...
  // True when the scenario has a kube_config block — i.e. a KubeDemandAgent will
  // be created for this run and kube_metrics should eventually appear in ticks.
  // False (null / undefined) means this is a non-kube scenario.
  const usesKubeDemand = selectedSpec?.kube_config != null
