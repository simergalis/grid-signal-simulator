...
class SiteConfig:
    ...
    # A rising crossing emits one latched turbine-commit signal.  The signal
    # starts exactly one offline unit and rearms only after actual fuel-cell
    # output falls below the configured fraction.  None = policy disabled.
