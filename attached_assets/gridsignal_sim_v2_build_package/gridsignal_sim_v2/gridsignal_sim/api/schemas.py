...
class ScenarioSpec(BaseModel):
    ...
    fuel_cell_turbine_commit_fraction: Optional[float] = Field(
        ...
        le=1.0,
        description=(
            "Actual fuel-cell fleet output fraction that emits one gas-turbine "
            "commit signal on each upward threshold crossing.  0.8 commits one "
            "standby turbine when fuel-cell output reaches 80% of fleet nameplate. "
            "The signal rearms only after output falls below the threshold. "
