...
def build_run_context_from_spec(
    ...
    # Fuel-cell saturation pre-commit — optional per-scenario policy.
    # A rising crossing emits one latched request for the turbine fleet; the
    # runtime owns crossing/latch state because it must reset for every run.
