...
- [Intrinsic block fuel-cell ramp](block-fuel-cell-intrinsic-ramp.md) — producing blocks always obey a proposed MW/s machine limit before optional fuel constraints.
